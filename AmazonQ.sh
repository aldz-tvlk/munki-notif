...
def main():
    ...
    amazon_q_mungki_version, amazon_q_web_version = versions.get('Amazon Q', (None, None))

    # Jika versi web dari website berbeda dengan yang ada di file CSV, perbarui dan kirim notifikasi
    if compare_versions(amazon_q_mungki_version, latest_amazon_q_version):
        ...
        send_notification_telegram("Amazon Q", amazon_q_mungki_version, latest_amazon_q_version)
    else:
